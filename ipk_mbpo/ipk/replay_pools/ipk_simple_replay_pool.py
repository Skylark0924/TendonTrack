...
class IPKSimpleReplayPool(FlexibleReplayPool):
    def __init__(self, observation_space, action_space, *args, **kwargs):
        ...
        super(IPKSimpleReplayPool, self).__init__(
            *args, fields_attrs=fields, **kwargs)

    def add_samples(self, samples):
        if not isinstance(self._observation_space, Dict):
            # pdb.set_trace()
            return super(IPKSimpleReplayPool, self).add_samples(samples)
    ...
    def batch_by_indices(self,
        ...
        if not isinstance(self._observation_space, Dict):
            return super(IPKSimpleReplayPool, self).batch_by_indices(
