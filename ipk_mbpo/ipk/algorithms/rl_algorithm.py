...
from ipk.samplers import rollouts
...
class RLAlgorithm(tf.contrib.checkpoint.Checkpointable):
    ...
    def _initial_exploration_hook(self, env, initial_exploration_policy, pool, fake_env):
    ...
    def _evaluation_paths(self, policy, evaluation_env, fake_env):
    ...
    def _do_sampling(self, timestep, fake_env):
        self.sampler.sample(fake_env)
