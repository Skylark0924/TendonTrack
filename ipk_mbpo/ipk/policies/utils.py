...
def get_basic_policy():
    from .ipk_basic_policy import IPKBasicPolicy
    policy = IPKBasicPolicy()
    return policy


def get_gaussian_policy(env, Q, **kwargs):
    from .ipk_gaussian_policy import FeedforwardGaussianPolicy
...
def get_uniform_policy(env, *args, **kwargs):
    from .ipk_uniform_policy import UniformPolicy
...
POLICY_FUNCTIONS = {
    'IPKGaussianPolicy': get_gaussian_policy,
    'IPKUniformPolicy': get_uniform_policy,
    'IPKBasicPolicy': get_basic_policy,
}
