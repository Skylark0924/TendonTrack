...
MAX_PATH_LENGTH_PER_DOMAIN = {
    'Point2DEnv': 50,
    'Pendulum': 200,
    'Tendon': 10,  # 初始化 pool 需要的 sample 数
    'Tendon_Tracking': 300,
}
...
ALGORITHM_PARAMS_ADDITIONAL = {
    'IPK': {
        ...
        'kwargs': {
            ...
            'n_initial_exploration_steps': int(600),
        }
    },
    'MBPO': {
        'type': 'MBPO',
...
def get_variant_spec(args, env_params):
    ...
    if env_params.type == 'MBPO' or env_params.type == 'SQL' or env_params.type == 'MVE' or env_params.type == 'SAC':
