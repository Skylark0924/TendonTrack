...
from ipk.policies.utils import get_policy_from_variant, get_policy
from softlearning.replay_pools.utils import get_replay_pool_from_variant
from ipk.samplers.utils import get_sampler_from_variant
...
sys.path.append("/home/lab/Github/TendonTrack/ipk_mbpo")
sys.path.append("/home/lab/Github/TendonTrack")
sys.path.append("/home/lab/Github/TendonTrack/ipk_mbpo/ipk")
...
class ExperimentRunner(tune.Trainable):
    ...
    def _build(self):
        ...
        initial_exploration_policy = self.initial_exploration_policy = (
            get_policy('IPKUniformPolicy', training_environment))
