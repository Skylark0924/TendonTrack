...
if __name__ == '__main__':
    # origin mbpo
    # run_example_local("examples.development", {f'--config=examples.config.halfcheetah.0', f'--gpus=1', f'--trial-gpus=1'})
    # ipk
    # run_example_local("ipk_development", {f'--config=config.custom.IPK', f'--gpus=1', f'--trial-gpus=1'})
    # MBPO
    # run_example_local("development", {f'--config=config.custom.MBPO', f'--gpus=1', f'--trial-gpus=1'})
    # SAC
    run_example_local("development", {f'--config=config.custom.SAC', f'--gpus=1', f'--trial-gpus=1'})